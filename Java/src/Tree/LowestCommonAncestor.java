...
*************************************
if both p and q exist in Tree rooted at root, then return their LCA (already find answer)
...
public class LowestCommonAncestor {
    public TreeNode find(TreeNode root, TreeNode p, TreeNode q){
        ...
        if (left != null && right != null) return root;     // 不断回溯直到发现一个子树中存在所要找的p，q，这个子树的根结点就是LCA

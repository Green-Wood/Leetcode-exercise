...
import Exercises.BinarySearch.MinimumSizeSubarraySum;
...
public class MinimumCostForTicket {
    ...
    public static void main(String[] args) {
        System.out.println(new MinimumCostForTicket().mincostTickets(
                new int[]{1,2,3,4,6,8,9,10,13,14,16,17,19,21,24,26,27,28,29}, new int[]{3, 14, 50}));
    }
}
